...
package eu.sample.cast.refplayer;

import eu.sample.cast.refplayer.settings.CastPreference;
...
public class CastApplication extends Application {
    ...
    public void onCreate() {
        ...
        APPLICATION_ID =  PreferenceManager.getDefaultSharedPreferences(this).getString("app_id", getString(R.string.app_id));
